...
<head>
    <meta charset="UTF-8">
    <title>Tech News - IDMETAFORA ERP</title>
...
<body>
    ...
    <header class="py-3 border-bottom col-md-12" style="background-color: ">
        <div class="container col-md-10 pt-5">
            <img src="tech_img/imgAcc1.png" alt="" class="position-absolute" style="top: -0px; left: -120px;"
                width="7%">

            <img src="tech_img/imgAcc2.png" alt="" class="position-absolute" style="top: -0px; right: -120px;"
                width="30%">
            <div class="row align-items-center">
                <div class="col-md-6 ">
                    <h1 class="font-weight-bold">
                        <span class="">Tech</span><span class="text-danger">News</span>
                    </h1>
                    <h6 class="font-weight-light py-3" data-aos="fade-right" data-aos-offset="300"
                        data-aos-easing="ease-in-sine">
                        Selamat datang di Technews IDMETAFORA, sumber informasi terbaru seputar teknologi dan inovasi.
                        Di sini, kami menyajikan berita terkini, ulasan mendalam, serta analisis dari berbagai
                        perkembangan teknologi yang berdampak langsung pada dunia bisnis dan kehidupan sehari-hari.
                    </h6>
                ...
                <div class="col-md-6" data-aos="fade-left" data-aos-offset="300" data-aos-easing="ease-in-sine">
                    <img src="tech_img/imgHeader.png" alt="" class="img-fluid">
                    <img src="tech_img/imgAcc.png" alt="" class="position-absolute" style="top: -30px; left: -50px;"
                        width="30%">
                </div>
            </div>
        </div>
    ...
    <section class="py-5 border-bottom">
        <div class="container col-md-8">
            <div class="row">
                <div class="col-md-12"
                    style="border-radius: 20px; border: 1px solid #E7F4FA; background-color: #F2BFAF; padding: 20px;">
                    <img src="tech_img/A0.png" alt="" class="position-absolute" style="bottom: -50px; left: -70px;"
                        width="15%">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <span class="font-weight-bold">Mengenal Quality Management System (QMS):
                                Pengertian hingga Implementasi di Perusahaan</span>
                            <span>December,15 2023</span>
                            <br>
                            <a href="#" class="btn btn-success mt-3">lebih Lanjut</a>
                        </div>
                        <div class="col-md-6">
                            <img src="tech_img/imgQms.png" alt="" width="100%">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                <img class=" card-img-top" src="tech_img/A1.png" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">Mengenal perangkat Teknologi smart home yang saat ini sedang
                                        populer</p>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                <img class=" card-img-top" src="tech_img/A2.png" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">Economy WorldWide</p>
                                    <a href="#" class="btn btn-primary">Go somewhere</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                <img class="card-img-top" src="tech_img/A3.png" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                                    <p class="card-text">Google Collaboratory</p>
                                    <a href="#" class="btn btn-primary">Go somewhere</a>
                                </div>
                            </div>
    ...
    <section class="py-5"
        style="background-image: url('tech_img/bgImg.png'); background-size: cover; background-position: center">
        <div class="container col-md-8">
            <div class="row py-3">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                <img class=" card-img-top" src="tech_img/blog/1.png" alt="Card image cap">
                                <div class="card-body">
                                    <h6 class="card-title">Mengenal Quality Management System (QMS): Pengertian hingga
                                        Implementasi di Perusahaan</h6>
                                    <p class="card-text text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Nunc
                                        scelerisque tortor sit amet condimentum porttitor. Integer augue urna, volutpat
                                        in sapien a, convallis commodo quam.</p>
                                    <div class="d-flex justify-content-between">
                                        <h6>December,15 2023</h6>
                                        <a href="#">Lanjut</a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <img class=" card-img-top" src="tech_img/blog/2.png" alt="Card image cap">
                                <div class="card-body">
                                    <h6 class="card-title">Business Intelligence: Pengertian, Peran, dan Manfaatnya Bagi
                                        Perusahaan</h6>
                                    <p class="card-text text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Nunc
                                        scelerisque tortor sit amet condimentum porttitor. Integer augue urna, volutpat
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card">
                                ...
                                <img class=" card-img-top" src="tech_img/blog/3.png" alt="Card image cap">
                                <div class="card-body">
                                    <h6 class="card-title">Strategi Omnichannel dan ERP: Peningkatan Efisiensi
                                        Operasional dan Pengambilan Keputusan Bisnis
                                    </h6>
                                    <p class="card-text text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Nunc
                                        scelerisque tortor sit amet condimentum porttitor. Integer augue urna, volutpat
            ...
            <div class="row py-3">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                <img class=" card-img-top" src="tech_img/blog/4.png" alt="Card image cap">
                                <div class="card-body">
                                    <h6 class="card-title">Apa itu Sistem Cerdas: Kenali Bagaimana Karakteristik, Cara
                                        Kerja, dan Contohnya</h6>
                                    <p class="card-text text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Nunc
                                        scelerisque tortor sit amet condimentum porttitor. Integer augue urna, volutpat
                                        in sapien a, convallis commodo quam.</p>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <img class=" card-img-top" src="tech_img/blog/5.png" alt="Card image cap">
                                <div class="card-body">
                                    <h6 class="card-title">Business Intelligence: Pengertian, Peran, dan Manfaatnya Bagi
                                        Perusahaan</h6>
                                    <p class="card-text text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <img class=" card-img-top" src="tech_img/blog/6.png" alt="Card image cap">
                                <div class="card-body">
                                    <h6 class="card-title">10 Contoh Perusahan yang Menerapkan Sistem ERP dalam
            ...
            <div class="row py-3">
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card">
                                <img class=" card-img-top" src="tech_img/blog/7.png" alt="Card image cap">
                                <div class="card-body">
                                    <h6 class="card-title">12 Rekomendasi Software ERP Terbaik Di Indonesia</h6>
                                    <p class="card-text text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Nunc
                                        scelerisque tortor sit amet condimentum porttitor. Integer augue urna, volutpat
                                        in sapien a, convallis commodo quam.</p>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <img class=" card-img-top" src="tech_img/blog/8.png" alt="Card image cap">
                                <div class="card-body">
                                    <h6 class="card-title">Software ERP Cloud di Indonesia: Pengertian, Konsep, Cara
                                        Kerja, Manfaat, dan Tantangan Penerapannya</h6>
                                    <p class="card-text text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Nunc
                                        scelerisque tortor sit amet condimentum porttitor. Integer augue urna, volutpat
                                        in sapien a, convallis commodo quam.</p>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <img class=" card-img-top" src="tech_img/blog/9.png" alt="Card image cap">
                                <div class="card-body">
                                    <h6 class="card-title">Sistem ERP: Pengertian, Sejarah, Manfaat, Jenis, Cara Kerja,
                                        Kelebihan, Kekurangan</h6>
                                    <p class="card-text text-justify">Lorem ipsum dolor sit amet, consectetur adipiscing
                                        elit. Nunc
                                        scelerisque tortor sit amet condimentum porttitor. Integer augue urna, volutpat
                                        in sapien a, convallis commodo quam.</p>
