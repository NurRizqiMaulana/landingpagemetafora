...
<head>
    <meta charset="UTF-8">
    <title>Audit System - IDMETAFORA ERP</title>
...
<body>
    ...
    <header class=" border-bottom border-top py-5" style="background-color: #D8EAFE">
        <div class="container col-md-10 pb-5">
            <div class="row align-items-center ">
                <div class="col-md-6">
                    <p class="font-weight-bold h2">
                        <span class="text-danger">Jasa</span> Pembuatan Sistem Audit <br>
                        <span class="text-primary">IDMETAFORA</span>
                    </p>
                    <p class="font-weight-normal h6 py-3">Jasa Pembuatan Sistem Audit merupakan salah satu layanan yang
                ...
                <div class="col-md-6 d-none d-md-block">
                    <!-- <img src="accounting_img/acc/0.png" class="position-absolute" style="top: -50px; right: -60px;"
                        alt="" width="80%"> -->
                    <img src="audit_img/imgHeader.png" alt="" class="img-fluid" width="100%">
                    <img src="audit_img/acc/1.png" alt="" class="position-absolute" style="top: 30%; right: -100px;"
                        width="10%">
    ...
    <section class="pb-5 border-bottom" style="background-color: #D8EAFE">
        ...
        <div class="container col-md-8">
            <img src="audit_img/acc/2.png" alt="" class="position-absolute" style="bottom: -25%; right: -25%;"
                width="25%">

            <img src="audit_img/acc/4.png" alt="" class="position-absolute" style="top: 80%; right: -25%;" width="15%">
    ...
    <section class="py-5 border-bottom">
        <div class="container col-md-10">
            <div class="row py-5">
                <div class="col-md-12">
                    <img src="audit_img/acc/3.png" alt="" class="position-absolute" style="top: -100px; left: -110px"
                        width="25%">
                    <p class="text-center font-weight-bold h3 py-5">
                        Manfaat Sistem Audit <br>
                        <span class="text-primary">IDMETAFORA</span>
                    <p></p>
                </div>
            </div>
            <div class="row py-3">
                <div class="col-md-12 d-flex justify-content-center gap-5">
                    <div class="col-md-3 text-center card-custom-1 p-4">
                        <div>
                            <img src="audit_img/icon/1.png" alt="" class="position-absolute" width="40%"
                                style="top: -100px; left: 60px">
                            <p class="font-weight-bold ">Manfaat Sistem Audit 1</p>
                            <p class="text-light">Pencatatan transaksi dapat tetap berlangsung tanpa internet dan
                                sistem
                                akan
                                menyingkronkan data ketika koneksi internet kembali.</p>
                        </div>
                    </div>
                    <div class="col-md-3 text-center card-custom-2 p-4">
                        <img src="audit_img/icon/2.png" alt="" class="position-absolute" width="40%"
                            style="top: -100px; left: 60px">
                        <p class="font-weight-bold ">Manfaat Sistem Audit 2</p>
                        <p class="text-light">Anda bisa mengelola pelanggan dan penjualan dari semua cabang, serta
                            mengaskses informasi lainnya secara real-time.</p>
                    </div>

                    <div class="col-md-3 text-center card-custom-3 p-3">
                        <img src="audit_img/icon/3.png" alt="" class="position-absolute" width="40%"
                            style="top: -100px; left: 60px">
                        <p class="font-weight-bold ">Manfaat Sistem Audit 3</p>
                        <p class="text-light">Software kasir ini dapat digunakan di perangkat apapun selama terkoneksi
                            internet. Anda bisa memantau penjualan kapanpun.</p>
                    </div>

                    <div class="col-md-3 text-center card-custom-4 p-4">
                        <img src="audit_img/icon/4.png" alt="" class="position-absolute" width="40%"
                            style="top: -100px; left: 60px">
                        <p class="font-weight-bold ">Manfaat Sistem Audit 4</p>
                        <p class="text-light">Dengan data yang tersentralisasi, Anda bisa meninjau performa bisnis
                            Anda
                            melalui tampilan analitik yang lengkap.</p>
                    </div>
    ...
    <section class="py-5 border-bottom"
        style="background-image: url('audit_img/bg2.png'); background-size: cover; background-position: center">
        <h2 class="text-center mb-5 font-weight-bold pt-5"> <span class=text-danger>Fitur-Fitur <br></span>
            Sistem Audit <span class=text-primary> IDMETAFORA</span>
        </h2>
        <div class="container col-md-8">
            <div class="col-md-12"
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4 mb-4">
                        <div class="custom-card text-center p-3 bg-white">
                            <img src="audit_img/icon/5.png" class="img-fluid" width="50%" alt="Purchasing System">
                            <p class="" style="font-size: 14px;font-weight: bold ">Fitur Sistem Audit 1</p>
                            <p>Fitur yang memudahkan anda dalam pengkategorian sebuah produk yang anda miliki.</p>

                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="custom-card text-center p-3 bg-white">
                            <img src="audit_img/icon/6.png" class="img-fluid" width="50%" alt="Accounting System">
                            <p class="" style="font-size: 14px;font-weight: bold">Fitur Sistem Audit 2
                            </p>
                            <p>Fitur pencarian untuk memudahkan anda dalam mencari produk yang ingin anda tampilkan.
                            </p>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="custom-card text-center p-3 bg-white">
                            <img src="audit_img/icon/7.png" class="img-fluid" width="50%" alt="Business Intelligence">
                            <p class="" style="font-size: 14px;font-weight: bold">Fitur Sistem Audit 3</p>
                            <p>Kelola data barang setiap saat yang masuk kedalam gudang pneyimpanan anda.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="pb-5 border-bottom"
        ...
        <div class="container col-md-8">
            <img src="audit_img/acc/5.png" alt="" class="position-absolute" style="top: 0; left: -25%" width="15%">

            <img src="audit_img/acc/6.png" alt="" class="position-absolute" style="top: 0; right: -25%" width="15%">

            <img src="audit_img/acc/7.png" alt="" class="position-absolute" style="bottom: 30%; right: -10%" width="5%">
