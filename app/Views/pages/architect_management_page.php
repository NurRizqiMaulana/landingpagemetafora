...
<head>
    <meta charset="UTF-8">
    <title>Architect Management - IDMETAFORA ERP</title>
...
<body>
    ...
    <header class="py-3 border-bottom border-top" style="background-color: #E7F4FA;">
        <div class="container pt-5">
            <div class="row align-items-center ">
                <div class="col-md-6 ">
                    <h1 class="font-weight-bold">
                        <span class="text-center" style="color: #38567F; font-weight: bold">Architect Management System
                            Development Services</span>
                    </h1>
                    <h6 class="py-3">Layanan Pengembangan Sistem Manajemen Arsitek adalah salah satu layanan yang
                        ditawarkan
                        oleh Tim IDMETAFORA.

                    </h6>
                    <a href="#" class="btn btn-primary"><i class="fa-solid fa-rocket"></i> Hubungi Kami</a>
                </div>
                <img src="architect_img/acc/0.png" alt="" class="position-absolute" style="top: 0; right: 0;"
                    width="35%">
                <div class="col-md-6">
                    <img src="architect_img/imgHeader.png" alt="" class="img-fluid">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container col-md-10">
            <div class="row">
                <div class="col-md-6 d-flex flex-column justify-content-center">
                    <img src="architect_img/acc/1.png" alt="" class="position-absolute"
                        style="bottom: 0; left: -20%; width: 20%;">
                ...
                <div class="col-md-6">
                    <img src="architect_img/img1.png" alt="" width="80%">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container col-md-10">
            <div class="row">
                ...
                <div class="col-md-12 text-center py-5">
                    <h3 class="font-weight-bold">Manfaat Architect Management System <br> <span
                            class="text-danger">IDMETAFORA</span></h3>
                </div>
            </div>
            <div class="row col-md-12">
                <img src="architect_img/acc/2.png" alt="" class="position-absolute"
                    style="bottom: 0; left: 100px; width: 70%;">
                <div class="col-md-4">
                    <div class="col-md-10 mb-4">
                        <div class="card shadow" style="border-radius: 0px 20px 0px 20px; background-color: #E7F4FA">
                            <div class="card-body text-right">
                                <img src="architect_img/icon/2.png" alt="Proyek Kontrak" class="img-fluid mb-3"
                                    width="15%">
                                <h6 class="font-weight-bold">Manfaat Sistem Manajemen Arsitek 1</h6>
                                <p class="card-text" style="font-size: 12px;">
                                    Merekam transaksi tanpa internet dan sinkronisasi sistem otomatis saat terhubung
                                    kembali ke internet.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="col-md-10 mb-4">
                        <div class="card shadow" style="border-radius: 0px 20px 0px 20px; background-color: #E7F4FA">
                            <div class="card-body text-right">
                                <img src="architect_img/icon/1.png" alt="Proyek Kontrak" class="img-fluid mb-3"
                                    width="15%">
                                <h6 class="font-weight-bold">Manfaat Sistem Manajemen Arsitek 2</h6>
                                <p class="card-text" style="font-size: 12px;">
                                    Dapat mengelola pelanggan dan penjualan dari semua cabang serta mengakses informasi
                ...
                <div class="col-md-4">
                    <img src="architect_img/img2.png" alt="" width="100%">

                </div>

                <div class="col-md-4">
                    <div class="col-md-10 mb-4">
                        <div class="card shadow" style="border-radius: 20px 0px 20px 0px; background-color: #E7F4FA">
                            <div class="card-body text-left">
                                <img src="architect_img/icon/3.png" alt="Proyek Kontrak" class="img-fluid mb-3"
                                    width="15%">
                                <h6 class="font-weight-bold">Manfaat Sistem Manajemen Arsitek 3</h6>
                                <p class="card-text" style="font-size: 12px;">
                                    Dapat digunakan di semua perangkat asalkan terhubung ke internet. Anda dapat
                                    memantau penjualan kapan saja dan di mana saja.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-10 mb-4">
                        <div class="card shadow" style="border-radius: 20px 0px 20px 0px; background-color: #E7F4FA">
                            <div class="card-body text-left">
                                <img src="architect_img/icon/4.png" alt="Proyek Kontrak" class="img-fluid mb-3"
                                    width="15%">
                                <h6 class="font-weight-bold">Manfaat Sistem Manajemen Arsitek 4</h6>
                                <p class="card-text" style="font-size: 12px;">
                                    Dapat meninjau kinerja bisnis melalui tampilan analitik lengkap dengan data
                                    terpusat.
                                </p>
                            </div>
                        </div>
        ...
        <div class="container col-md-8">
            <div class="row py-5">
                <div class="col-md-12 text-center">
                    <h1 class="font-weight-bold">Fitur-Fitur Architect Management<br>
                        System <span class="text-danger">IDMETAFORA</span></h1>
                    <p class="py-3">Architect Management System IDMETAFORA membantu mengelola proyek arsitektur dengan
                        efisien,
                        meningkatkan kolaborasi, dan mengendalikan biaya secara efektif.</p>
                </div>
            ...
            <div class="row align-items-center justify-content-center">
                ...
                <img src="fab_img/bgScreen.png" alt="" class="position-absolute" style=" left: -20px;bottom: -60px"
                    width="105%">
                <div class="col-md-4">
                    <div class="shadow mb-4 p-3" style="border-radius: 20px; background-color: #EFF4F6">
                        <div class="d-flex align-items-center">
                            ...
                            <p class="font-weight-bold mb-0 ms-2 px-2">Fitur Sistem Manajemen Arsitek 1</p>
                        </div>
                        <div>
                ...
                <div class="col-md-4">
                    <div class="shadow mb-4 p-3" style="border-radius: 20px; background-color: #EFF4F6">
                        <div class="d-flex align-items-center">
                            ...
                            <p class="font-weight-bold mb-0 ms-2 px-2">Fitur Sistem Manajemen Arsitek 2</p>
                        </div>
                        <div>
                ...
                <div class="col-md-4">
                    <div class="shadow mb-4 p-3" style="border-radius: 20px; background-color: #EFF4F6">
                        <div class="d-flex align-items-center">
                            ...
                            <p class="font-weight-bold mb-0 ms-2 px-2">Fitur Sistem Manajemen Arsitek 3</p>
                        </div>
                        <div>
                ...
                <div class="col-md-4">
                    <div class="shadow mb-4 p-3" style="border-radius: 20px; background-color: #EFF4F6">
                        <div class="d-flex align-items-center">
                            ...
                            <p class="font-weight-bold mb-0 ms-2 px-2">Fitur Sistem Manajemen Arsitek 4</p>
                        </div>
                        <div>
                            <p class="">Kelola data setiap barang yang masuk gudang penyimpanan.</p>
                        </div>
        ...
        <div class="container col-md-8 py-5">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <img src="architect_img/acc/3.png" alt="" class="position-absolute"
                        style="top: -100px; right: -225px;" width="60%">
                    <div class="col-md-4">
                        <img src="fab_img/img3.png" alt="" width="130%">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="font-weight-bold h2"
                        ...
                        Pertanyaan tentang Architect Management System
                        Development Services
                    </p>
                    <p class="font-weight-light h6">
                        Hal yang sering ditanyakan oleh user yang ingin menggunakan Architect Management System
                        Development Services.
                    </p>
                </div>
            </div>
                            ...
                            <div class="card">
                                <div class="card-header" id="headingOne">
                                    <h5 class="mb-0">
                                        <button class="btn btn-link font-weight-bold" data-toggle="collapse"
                                            ...
                                            Architect Management System Apa Yang Kami Tawarkan?
                                        </button>
                                    </h5>
                                </div>
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <ol type="1">
                                            <li>Halaman Data Pajak.
                                            </li>
                                            <li>Halaman Data dan Detail Kelompok Pengguna.
                                            </li>
