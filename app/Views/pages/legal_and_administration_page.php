...
<head>
    <meta charset="UTF-8">
    <title>Legal & Administration System - IDMETAFORA ERP</title>
...
<body>
            ...
            <div class="row align-items-center ">
                <div class="col-md-6">
                    <p class="font-weight-bold h1">
                        Jasa Pembuatan <br>
                        <span style="font-family: 'Covered By Your Grace', cursive; font-style: italic; color: #009387">
                            Sistem</span>
                        Legal dan Administrasi
                    </p>
                    <p class="font-weight-bold h6 py-3">Jasa Pembuatan Sistem Legal dan Administrasi merupakan salah
                ...
                <div class="col-md-6 d-none d-md-block">
                    <!-- <img src="accounting_img/acc/0.png" class="position-absolute" style="top: -50px; right: -60px;"
                        alt="" width="80%"> -->
                    <img src="lab_img/imgHeader.png" alt="" class="img-fluid" width="100%">
                    <img src="lab_img/acc/0.png" alt="" class="position-absolute" style="bottom: -25%; right: 0%;"
                        width="80%">
    ...
    <section class="py-5 border-bottom">
        <div class="container col-md-8">
            <div class="row py-5">
                <div class="col-md-12">
                    <p class="text-center font-weight-bold h3">
                        Manfaat <br> Sistem Legal dan Administrasi
            ...
            <div class="row py-3">
                <div class="col-md-6">
                    <p class="font-weight-bold ">Legalitas</p>
                    <p class="text-justify" style="font-size: 16px">Legalnya usaha artinya perusahaan dan seluruh
                        operasional di dalamnya telah dilindungi secara hukum.</p>
                </div>
                <div class="col-md-6 text-center">
                    <img src="lab_img/img1.png" alt="" width="100%">
                </div>
            </div>

            <div class="row py-3">
                <div class="col-md-6 text-center">
                    <img src="lab_img/img2.png" alt="" width="100%">
                </div>
                <div class="col-md-6">
                    <p class="font-weight-bold ">Mengurangi Resiko
                    </p>
                    <p class="text-justify" style="font-size: 16px">Menurunkan risiko bagi banyak pihak baik dari sisi
                        penjual maupun konsumen.</p>
                </div>
            </div>

            <div class="row py-3">
                <img src="lab_img/acc/1.png" alt="" class="position-absolute" width="25%"
                    style="bottom: -120px; left: -220px;">
                <div class="col-md-6">
                    <p class="font-weight-bold ">Mempermudah Pengolahan Data</p>
                    <p class="text-justify" style="font-size: 16px">System legal akan memudahkan user dalam memberikan
                        informasi kepada nasabah bahwa perusahaan mereka sudah berpayung hukum sehingga menimbulkan rasa
                        kepercayaan yang lebih kepada consumen untuk melakukan transaksi.</p>
                </div>
                <div class="col-md-6 text-center">
                    <img src="lab_img/img3.png" alt="" width="100%">
                </div>
            </div>
            <img src="lab_img/acc/2.png" alt="" class="position-absolute" style="right: -210px; bottom: 0px"
                width="20%">
    ...
    <section class="py-5 mb-5 border-bottom ">
        <h2 class="text-center mb-5 font-weight-bold"> <span class=text-danger>Fitur-Fitur <br></span>
            Sistem Legal dan Administrasi <span class=text-primary> IDMETAFORA</span>
        </h2>
        <div class="container col-md-8">
            <img src="lab_img/acc/3.png" alt="" class="position-absolute" style="top: -100px; left: -230px;" width="8%">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4 mb-4">
                        <div class="custom-card text-center p-3 bg-white">
                            <img src="lab_img/icon/1.png" class="img-fluid mb-4" width="50%" alt="Purchasing System">
                            <p class="" style="font-size: 14px;font-weight: bold">Halaman filter supplier ke pusat</p>

                        </div>
                    </div>
                    <div class="col-md-4 mb-4">
                        <div class="custom-card text-center p-3 bg-white">
                            <img src="lab_img/icon/2.png" class="img-fluid mb-4" width="50%" alt="Accounting System">
                            <p class="" style="font-size: 14px;font-weight: bold">Halaman data supplier
                                ke pusat
                            </p>
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="custom-card text-center p-3 bg-white">
                            <img src="lab_img/icon/3.png" class="img-fluid mb-4" width="50%"
                                alt="Business Intelligence">
                            <p class="" style="font-size: 14px;font-weight: bold">Halaman filter pusat ke cabang (keluar
                                dan terima)</p>
